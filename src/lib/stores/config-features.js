export const config = {
  "mapTitle": "Annual inflation rates in Europe September 2022", // The title of the map, if more than one word, separate by dash, e.g. "income-europe"
  "vercelURL": "https://map-inflation-september.vercel.app", // The url provided when deploying the map on Vercel
